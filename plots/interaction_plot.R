...
lines_inter_lh <- list(
  list(list(text=paste0("b=", fmt2_raw(cf_lh$beta),
                        ", 95% (CI ", fmt2_raw(cf_lh$ci_lo), " to ",
                        fmt2_raw(cf_lh$ci_hi), "), SE=", fmt2_raw(cf_lh$se), ","), sub=FALSE)),
  list(list(text=paste0("p=", fmt_p2sig_raw(cf_lh$p), sig_inter_raw(cf_lh$p),
                        ", p"), sub=FALSE),
...
lines_inter_fsh <- list(
  list(list(text=paste0("b=", fmt2_raw(cf_fsh$beta),
                        ", 95% (CI ", fmt2_raw(cf_fsh$ci_lo), " to ",
                        fmt2_raw(cf_fsh$ci_hi), "), SE=", fmt2_raw(cf_fsh$se), ","), sub=FALSE)),
  list(list(text=paste0("p=", fmt_p2sig_raw(cf_fsh$p), sig_inter_raw(cf_fsh$p),
                        ", p"), sub=FALSE),
       list(text="FDR", sub=TRUE),
